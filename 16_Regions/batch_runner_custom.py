...
for region_id in regions: 
    ...
    best_classes_path = os.path.join("/home/argus-vision/vision/VisionTrainingGround/LD/ultralytics/ultralytics/runs/detect", name, "best_classes/")
    px_err_path = f"custom_pxerr_eval/{name}_px_err.csv"


    os.makedirs(best_classes_path, exist_ok=True)
    output_path = "util/custom_err_files/"
