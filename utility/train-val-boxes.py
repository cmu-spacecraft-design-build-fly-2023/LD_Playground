...
def draw_landmark_boxes(base_path, image_name):
    ...
    label_path = os.path.join(base_path, 'val/labels', os.path.splitext(image_name)[0] + '.txt')
...
# Example usage
base_path = '/home/argus-vision/vision/VisionTrainingGround/LD/datasets/17R_dataset_temp'
